...
class UpgradePlansForm {
  ...
  public static function insertForm(array &$form, FormStateInterface $form_state) {
                            ...
                            <p class="pricing-rate"><sup>$</sup> 399<sup>*</sup></p>
                                ...
                                <div class="pricing-list">
                                    <ul>
                                              <li>' . t('Supports JSON API module') . '</li>
                                              <li>' . t('Supports default REST APIs') . '</li>
                                              <li>' . t('Supports restriction of custom APIs') . '</li>
                                              <li>' . t('API Key Authentication') . '</li>
                                              <li>' . t('Basic Authentication') . '</li>
                                              <li>' . t('Access Token Based Authentication') . '</li>
                                              <li>' . t('JWT Based Authentication') . '</li>
                                              <li>' . t('Authenticate private files and images') . '</li>
                                              <li>' . t('Support for multiple authentication methods') . '</li>
                                              <li>' . t('3rd Party/External IDP Token Based Authentication') . '</li>
                                              <li>' . t('Generate separate API Keys for every user') . '</li>
                                              <li>' . t('Custom Authentication Header') . '</li>
                                              <li>' . t('Configurable Token Expiry Time') . '</li>
                                              <li>' . t('Allow or restrict the custom APIs') . '</li>
                                              <li>' . t('IP Address Based Restriction') . '</li>
                                              <li>' . t('Role Based Restriction') . '</li>
                                              <li>' . t('Premium GoTo Meeting Support') . '</li>
                                    </ul>
                                </div>
                            </div>
    ...
    $form['upgrade-plans']['upgrade_container_outline']['instr'] = [
      '#markup' =>
      '<br>' . t(
          'The above-mentioned cost is applicable for one instance only. If you are planning to use the module on multiple instances, you can check out the bulk purchase discount on our <a href="@url" target="_blank">@website</a>.',
          [
            '@url' => 'https://plugins.miniorange.com/drupal-rest-api-authentication#pricing',
            '@website' => t('website'),
          ]
      ) .
      '<br><br><br><b>' . t('10 Days Return Policy -') . '</b><br><br>' .
      t(
          'At miniOrange, we want to ensure that you are 100% happy with your purchase. If the premium module you purchased is not working as advertised and you have attempted to resolve any issues with our support team, which could not get resolved, we will refund the whole amount given that you have a raised a refund request within the first 10 days of the purchase.'
      ) .
      '<br><br>' . t(
          'Please email us at <a href="mailto:@email">@email</a> for any queries.',
