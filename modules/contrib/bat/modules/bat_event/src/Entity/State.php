 ...
 * @ContentEntityType(
 *   id = "state",
 *   label = @Translation("Bat Event State"),
 *   handlers = {
...
class State extends ContentEntityBase implements StateInterface {
   ...
   *   A boolean indicating whether the query access check.
   */
  public static function loadByMachineName($machine_name, $access_check = TRUE) {
