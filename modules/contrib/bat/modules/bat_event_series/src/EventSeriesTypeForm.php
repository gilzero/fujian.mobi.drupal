...
class EventSeriesTypeForm extends BundleEntityFormBase {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['name'] = [
      ...
      '#description' => $this->t('The human-readable name of this event series type.'),
      '#required' => TRUE,
      '#size' => 30,
    ];
    ...
    $form['type'] = [
      ...
      '#description' => $this->t('A unique machine-readable name for this event series type. It must only contain lowercase letters, numbers, and underscores.'),
    ];

    $form['event_granularity'] = [
      '#type' => 'select',
      '#title' => $this->t('Event Granularity'),
      '#options' => [
        'bat_daily' => $this->t('Daily'),
        'bat_hourly' => $this->t('Hourly'),
      ],
    ...
    $form['target_event_type'] = [
      '#type' => 'select',
      '#title' => $this->t('Target Event Type'),
      '#options' => $options,
  ...
  protected function actions(array $form, FormStateInterface $form_state) {
    ...
    $actions['submit']['#value'] = $this->t('Save event series type');
    $actions['delete']['#value'] = $this->t('Delete event series type');
    return $actions;
  }
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    if ($status == SAVED_UPDATED) {
      $this->messenger()->addMessage($this->t('The event series type %name has been updated.', $t_args));
    }
    elseif ($status == SAVED_NEW) {
      $this->messenger()->addMessage($this->t('The event series type %name has been added.', $t_args));
    }
