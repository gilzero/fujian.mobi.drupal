...
/**
 * Twig filters for converting colors.
 */
class TwigColor extends AbstractExtension {
  ...
  public function getFilters(): array {
    return [
      ...
      new TwigFilter('css_rgb_to_hex', [$this, 'cssRgbToHex']),
      new TwigFilter('hex_to_rgb', [$this, 'hexToRgb']),
      new TwigFilter('hex_to_css_rgb', [$this, 'hexToCssRgb']),
    ];
  }
   ...
   */
  public static function cssRgbToHex(string $string) {
   ...
   */
  public static function hexToCssRgb(string $hex) {
