...
class TwigConvertTest extends UnitTestCase {
   ...
   */
  public function providerTestBooleanValues(): array {
    return [
   ...
   */
  public function providerTestIntegerValues(): array {
    return [
      ["{{ 42|integer }}", '42'],
      ["{{ 4.2|integer }}", '4'],
      ["{{ '42'|integer }}", '42'],
   ...
   */
  public function providerTestFloatValues(): array {
    return [
      ["{{ 42|float }}", '42'],
      ["{{ 4.2|float }}", '4.2'],
      ["{{ 0.42|float }}", '0.42'],
   ...
   */
  public function providerTestStringValues(): array {
    return [
      ["{{ 42|string }}", "42"],
      ["{{ 4.2|string }}", "4.2"],
      ["{{ '42'|string }}", "42"],
   ...
   */
  public function providerTestMd5Values(): array {
    return [
   ...
   */
  public function providerTestJsonDecodeValues(): array {
    return [
      ['{% set json = \'{
        "a": 1,
        "b": 2,
   ...
   */
  public function providerTestDateFromFormat(): array {
    return [
      [
   ...
   */
  public function providerTestBase64Encode(): array {
    return [
      [
   ...
   *   An array of test strings in plain text and base64 format.
   */
  public function providerTestBase64Decode(): array {
    return [
      [
      ...
      [
        "{{ '&VGhpcyBpcyBhbiBlbmNvZGVkIHN0cmluZw=='|base64_decode }}",
        'This is an encoded string',
      ],
      [
        "{{ '&VGhpcyBpcyBhbiBlbmNvZGVkIHN0cmluZw=='|base64_decode(true) is same as (false) ? 'false' : 'true' }}",
        'false',
      ],
      [
