...
class TwigColorTest extends UnitTestCase {
   ...
   */
  public function providerTestRgbToHexValues(): array {
    return [
   ...
   */
  public function providerTestCssRgbToHexValues(): array {
    return [
   ...
   *   An array of test data with twig values and their hex equivalents.
   */
  public function providerTestHexToRgbValues(): array {
    return [
   ...
   *   An array of test data with twig values and their hex equivalents.
   */
  public function providerTestHexToCssRgbValues(): array {
    return [
